...
```groovy
implementation 'com.github.awxkee:avif-coder:1.5.7' // or any version above picker from release tags
...
implementation 'com.github.awxkee:avif-coder-coil:1.5.7' // or any version above picker from release tags
```
