...
```groovy
implementation 'com.github.awxkee:avif-coder:1.5.10' // or any version above picker from release tags

// Glide avif plugin if you need one
implementation 'com.github.awxkee:avif-coder-glide:1.5.10' // or any version above picker from release tags

// Coil avif plugin if you need one
implementation 'com.github.awxkee:avif-coder-coil:1.5.10' // or any version above picker from release tags
```
