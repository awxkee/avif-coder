...
// Wikipedia Link: https://en.wikipedia.org/wiki/Estrin%27s_scheme
            ...
            T Estrin(T x, T c0, T c1, T c2, T c3) {
                T x2 = Mul(x, x);
            ...
            T Estrin(T x, T c0, T c1, T c2, T c3, T c4) {
                T x2 = Mul(x, x);
                T x4 = Mul(x2, x2);
            ...
            T Estrin(T x, T c0, T c1, T c2, T c3, T c4, T c5) {
                T x2 = Mul(x, x);
                T x4 = Mul(x2, x2);
